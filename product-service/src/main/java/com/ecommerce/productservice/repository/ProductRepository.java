...
public interface ProductRepository extends MongoRepository<Product, String> {
    ...
    public Page<Product> findByNameContainingIgnoreCaseAndDescriptionContainingIgnoreCaseAndColorContainingIgnoreCaseAndSizeContainingIgnoreCaseAndTypeContainingIgnoreCaseAndSexContainingIgnoreCaseAndOriginalPriceBetweenAndCurrentPriceBetweenAndCreationDateBetween(String name, String description, String color, String productSize, String type, String sex, double minOriginalPrice, double maxOriginalPrice, double minCurrentPrice, double maxCurrentPrice, Date minCreationDate, Date maxCreationDate, Pageable pageable);
}
