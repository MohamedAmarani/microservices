...
public interface ProductRepository extends MongoRepository<Product, String> {
    ...
    public Page<Product> (String name, String description, String color, String productSize, String type, String sex, double minOriginalPrice, double maxOriginalPrice, double minCurrentPrice, double maxCurrentPrice, Date minCreationDateDate, Date maxCreationDate, Pageable pageable);
}
