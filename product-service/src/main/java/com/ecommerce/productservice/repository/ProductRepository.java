...
public interface ProductRepository extends MongoRepository<Product, String> {
    ...
    public Page<Product> findByNameContainingIgnoreCaseAndDescriptionContainingIgnoreCaseAndColorContainingIgnoreCaseAndSizeAndTypeAndSexAndOriginalPriceBetweenAndCurrentPriceBetween(String name, String description, String color, String productSize, String type, String sex, double minOriginalPrice, double maxOriginalPrice, double minCurrentPrice, double maxCurrentPrice, Pageable pageable);
}
